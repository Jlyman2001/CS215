...
int main( ) {
   ...
   cout << "*** Lab 6 (Part 1) tests on original array a: "
...
/**
 * Determines if a test was passed or failed, with a message on failure.
 * 
 * @param desiredOutput  The expected output for the test
 * @param actualOutput   The actual output of the test
 * @param testLabel      The name of the test
 * @post     Prints a message to standard output on test failure
...
/**
 * Runs tests to check Part 1.
 * 
 * @param a  An instance of the array to be tested
 * @pre      array a is empty
